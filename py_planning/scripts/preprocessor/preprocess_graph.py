import io
import abcfrom pyquaternion import Quaternion
...
import osfrom scipy.spatial.distance import cdist
import matplotlib.pyplot as plt
import colorsys
from preprocessor.preprocess_vector import PreprocessVectorizationfrom preprocessor.utils import AgentType, TrafficLight, rgba2rgbfrom utils.angle_operation import get_normalized_anglefrom utils.colored_print import ColorPrinter
...
class PreprocessGraphs(PreprocessVectorization):
    ...
    def process(self, idx: int, agent_idx: int):
        ...
        if np.any(inputs['target_agent_representation']) == None:
            return None
