...
import os
import math
from preprocessor.preprocess_vector_hivt import PreprocessVectorizationHiVTfrom preprocessor.utils import AgentType, TrafficLight

import thirdparty.configfrom commonroad.scenario.scenario import Scenariofrom utils.colored_print import ColorPrinterfrom utils.transform import XYYawTransformfrom utils.angle_operation import get_normalized_anglefrom commonroad.scenario.obstacle import ObstacleType

class CommonroadHiVTProcessor(PreprocessVectorizationHiVT):
    """
