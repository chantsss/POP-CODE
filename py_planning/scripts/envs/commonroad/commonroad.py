...
import os
import abc
import picklefrom typing import Dict, Any
import torch
import torch.utils.data as torch_data
import random
from utils.file_io import extract_folder_file_listfrom utils.file_io import read_yaml_configfrom preprocessor.utils import InterfaceMode
  ...
  def __init__(self, data_path: str,
    ...
    if self.is_extract_mode():
      ...
      for fname in file_list:
        ...
        if self.version in fname and encoder_type in fname and '.pt' in fname:
          self.read_file_list.append(fname)
