...
import matplotlib.pyplot as pltfrom type_utils.trajectory_point import TrajectoryPointfrom sumocr.interface.ego_vehicle import EgoVehiclefrom matplotlib.lines import Line2Dfrom matplotlib.text import Textfrom typing import List, Dict
import copy
import paper_plot.utils as paper_utilsfrom paper_plot.color_schemes import COLOR_RGB_MAP, FOUR_COLOR_SCHEME1, FIVE_COLOR_SCHEME1
import matplotlib.colors as mcolors

import thirdparty.configfrom commonroad.scenario.scenario import Scenariofrom commonroad.scenario.obstacle import ObstacleRole, DynamicObstaclefrom commonroad.common.util import Intervalfrom commonroad.geometry.shape import Rectangle
from preprocessor.commonroad.raster_renderer import RasterRendererfrom utils.transform import XYYawTransformfrom envs.commonroad.utils import read_params, rgba2rgbfrom .utility import limit_agent_length_width
...
class SimulationVisualizer:
  def __init__(self):
    ...
    self.__enable_paper_pdf_format = True
  ...
  def save_fig(self, video_path: str,
    ...
    if not is_first_frame:
      ...
      if self.__enable_paper_pdf_format:
        self.fig.savefig(
          os.path.join(video_path, '_frame_{}.svg'.format(frame_index)), 
