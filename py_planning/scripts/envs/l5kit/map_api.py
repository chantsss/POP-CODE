...
# get_lane_as_interpolation() is modified
from enum import IntEnumfrom functools import lru_cachefrom typing import Iterator, no_type_check, Sequence, Union

import numpy as np
import pymap3d as pm

import thirdparty.configfrom l5kit.configs.config import load_metadatafrom l5kit.data import DataManagerfrom l5kit.geometry import transform_pointsfrom l5kit.data.proto.road_network_pb2 import GeoFrame, GlobalId, MapElement, MapFragment
...
class MapAPI:
    ...
    def get_lane_as_interpolation(self, element_id: str, step: float, method: InterpolationMethod) -> dict:
        ...
        """
        read_dict = self.get_lane_coords(element_id)
        xyz_left = read_dict["xyz_left"]
        xyz_right = read_dict["xyz_right"]
