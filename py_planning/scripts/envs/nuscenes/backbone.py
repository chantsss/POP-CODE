# nuScenes dev-kit. Code written by Freddy Boulton 2020.
# modified: add pretrained optionfrom typing import Tuple

import torchfrom torch import nnfrom torchvision.models import (mobilenet_v2, resnet18, resnet34, resnet50,
                                resnet101, resnet152)
...
class ResNetBackbone(nn.Module):
    ...
    def __init__(self, version: str, pretrained: bool):
        """
        Inits ResNetBackbone
        :param version: resnet version to use.
        :papram pretrained: load pretrained model or not
        """
        super().__init__()
        ...
        self.backbone = trim_network_at_index(
            RESNET_VERSION_TO_MODEL[version](pretrained=pretrained), -1)
...
class MobileNetBackbone(nn.Module):
    ...
    def __init__(self, version: str, pretrained: bool):
        ...
        self.backbone = trim_network_at_index(mobilenet_v2(pretrained=pretrained), -1)
