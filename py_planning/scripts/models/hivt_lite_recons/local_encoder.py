...
from typing import Optional, Tuplefrom models.common.utils import TemporalData
# from models.common.nat_actor_net import NatActorNetfrom models.common.utils import init_weights
...
class ALEncoder(MessagePassing):
    ...
    def __init__(self,
        ...
        self.turn_direction_embed = nn.Parameter(torch.Tensor(2, embed_dim))
