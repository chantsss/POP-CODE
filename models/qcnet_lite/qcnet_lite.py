...
class QCNetLite(pl.LightningModule):
    ...
    def training_step(self,
        ...
        cls_loss = self.cls_loss(pred=traj_propose[:, :, -1:].detach(),
        ...
        loss = reg_loss_propose + cls_loss
        return loss
    ...
    def validation_step(self,
        ...
        traj_eval = traj_propose[eval_mask, :, :, :self.output_dim + self.output_head]
    ...
    def test_step(self,
        ...
        rot_mat[:, 1, 0] = -sin
        rot_mat[:, 1, 1] = cos
        traj_eval = torch.matmul(traj_propose[eval_mask, :, :, :2],
