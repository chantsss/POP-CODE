...
class QCNetDistill(pl.LightningModule):
    ...
    def __init__(self,
        ...
        if teacher_ckpt_path != '':
            ...
            self.teacher = QCNet.load_from_checkpoint(checkpoint_path=teacher_ckpt_path)
        else:
    ...
    def forward(self, data: HeteroData):
        ...
        # Give full observations to teacher
        with torch.no_grad():
            teacher_scene_enc = self.teacher.encoder(data)
        ...
        return pred, scene_enc, teacher_scene_enc
